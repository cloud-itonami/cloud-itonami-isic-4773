(ns specialtyretailops.phase
  "Phase 0->3 staged rollout for the ISIC-4773 'Other retail sale of new
  goods in specialized stores' operations-coordination actor.
    ...
    Phase 3  supervised auto        -- governor-clean, high-confidence
                                       ...
                                       and a high-cost `:coordinate-supply-
  ...
  `specialtyretailops.governor`'s own `always-escalate-ops` enforces the
  same invariant independently -- two layers, not one, agree on this."
  (:require [specialtyretailops.governor :as governor]))
...
(defn verdict->disposition
  "Map a SpecialtyRetailGovernor verdict to a base disposition before
  the phase gate."
  [verdict]
